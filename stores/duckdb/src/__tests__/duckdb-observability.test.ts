...
import { DuckDBConnection } from '../storage/db/index';
import { ObservabilityStorageDuckDB } from '../storage/domains/observability/index';
...
describe('ObservabilityStorageDuckDB', () => {
  ...
  it('reports span-events as preferred strategy', () => {
    expect(storage.tracingStrategy).toEqual({
      preferred: 'span-events',
      supported: ['span-events'],
    });
  });
